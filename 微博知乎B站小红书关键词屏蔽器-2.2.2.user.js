...
(function() {
    ...
    function createManagementUI() {
        ...
        style.textContent = `
            ...
            #keyword-blocker-panel {
                ...
                transition: left 0.3s ease; font-family: -apple-system, BlinkMacSystemFont, sans-serif;
            }
            ...
            .kb-input-group { display: flex; gap: 8px; }
            ...
            .kb-list-container { max-height: calc(70vh - 160px); overflow-y: auto; padding: 0; }
    ...
    function processContentElement(element, config) {
        ...
        if (site === 'bilibili') {
            if (element.classList.contains('bili-video-card') &&
                ...
                console.log(config.logPrefix + ': 反屏蔽提示');
                return;
            }
        }
    ...
    function init() {
        if (isCurrentSiteDisabled()) {
            console.log(`屏蔽器: ${getCurrentSite()} 已禁用，仅管理界面`);
